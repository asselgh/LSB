    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $storedPasswordHash)) {
          ...
          if ($row['approval'] == 'yes') {
            ...
            header("Location: ../clientportal.php?error=Your account hasn't been approved yet, please contact administration");
          }  
        } else {
    		header("Location: ../clientportal.php?error=Invalid Password");
        }
    } else {
    		header("Location: ../clientportal.php?error=Email not found");
    }
