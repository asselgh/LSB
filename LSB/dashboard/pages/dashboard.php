...
$stmt = $conn->prepare("SELECT firm_name, commercial_number FROM clients WHERE email = ?");
$stmt->bind_param("s", $email);
$stmt->execute();
$result = $stmt->get_result();

if ($result->num_rows > 0) {
    $firm_row = $result->fetch_assoc();
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" href="../pages/makerequest.php">Make a Request</a>
            </div>
          </div>
    ...
    $requestQuery = "SELECT COUNT(*) AS num_requests FROM requests WHERE commercial_number = $commercialNumber AND YEAR(date_time) = YEAR(CURRENT_DATE) AND MONTH(date_time) = MONTH(CURRENT_DATE);";
    ...
    $offerQuery = "SELECT COUNT(*) AS num_offers FROM offers o JOIN requests r ON o.request_id = r.id WHERE r.commercial_number = $commercialNumber AND YEAR(o.date_time) = YEAR(CURRENT_DATE) AND MONTH(o.date_time) = MONTH(CURRENT_DATE)";
    $offerResult = mysqli_query($conn, $offerQuery);
    $offerRow = mysqli_fetch_assoc($offerResult);
    $numOffers = $offerRow['num_offers'];
    
        // Query to get the count of offers for the last month
    $shipmentsQuery = "SELECT COUNT(*) AS num_shipments FROM shipments s JOIN requests r ON s.request_id = r.id WHERE r.commercial_number = $commercialNumber AND YEAR(s.date_time) = YEAR(CURRENT_DATE) AND MONTH(s.date_time) = MONTH(CURRENT_DATE)";
    ...
    $expensesQuery = "SELECT SUM(o.price) AS sum_prices
                      ...
                      WHERE r.commercial_number = $commercialNumber;
                      ";
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold" style="width: 105%;">This month's Requests</p>
                    <h5 class="font-weight-bolder mb-0"><?php echo $numRequests; ?> requests</h5>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class="font-weight-bolder mb-0"><?php echo $numOffers; ?> offers</h5>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class="font-weight-bolder mb-0">
                      <?php echo number_format($sumExpenses, 2); ?> SAR
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
      ...
      <?php if (isset($_GET['success']) && $_GET['success'] == 'Operation successful!'): ?>
    ...
    <div class="container-fluid py-4">
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    // Fetch data from the database
                            $sql = "SELECT s.*, r.service_type, r.destination, r.details, o.price, lc.company_name 
                    		FROM shipments s 
                            JOIN requests r 
      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Received Offers <small class="text-xs text-secondary">(Last 6)</small><a href="offers.php" class="text-secondary font-weight-bold text-xs px-3">See all</a></h6>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                                      <?php
                    // Fetch data from the database
                    $sql = "SELECT lc.company_name, r.service_type, r.destination, o.price, o.date_time, o.request_id, o.id 
                            FROM offers o 
                      ...
                      ?>                              </td>
                              ...
                              <td class="align-middle">          
                                <div class="dropdown">
                                    ...
                                    $request_id = base64_encode($row['request_id']);
                                    ?>
                    <a class="cursor-pointer text-secondary font-weight-bold text-xs" style="padding-right: 15px;" id="dropdownTable1" data-bs-toggle="dropdown" aria-expanded="false">
                                      Accept
                    </a>
                    <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable1">
                      <li><p class="text-xs mb-0">Are you sure you want to accept this offer?</p>
                          <p class="text-xs font-weight-bold mb-1">Once accepted, it cannot be reversed.</p></li>
					  <li><a class="dropdown-item border-radius-md" href="../../php/makeshipment.php?id=<?php echo $id; ?>&request_id=<?php echo $request_id; ?>&key=accept">Yes, I am sure</a></li>
                    </ul>
                    <a class="cursor-pointer text-secondary font-weight-bold text-xs" id="dropdownTable2" data-bs-toggle="dropdown" aria-expanded="false">
                                      Decline
                    </a>             
                     <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable2">
                      <li><p class="text-xs mb-0">Are you sure you want to decline this offer?</p>
                          <p class="text-xs font-weight-bold mb-1">Once declined, it cannot be reversed.</p></li>
					  <li><a class="dropdown-item border-radius-md" href="../../php/makeshipment.php?id=<?php echo $id; ?>&request_id=<?php echo $request_id; ?>&key=decline">Yes, I am sure</a></li>
                    </ul>               
                  </div>
                              </td>
                          </tr>
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <?php
// Fetch last 6 requests associated with $commercialNumber from the database using prepared statement
$sql = "SELECT service_type, details, destination, date_time, status, approval FROM requests WHERE commercial_number = ? ORDER BY date_time DESC LIMIT 6";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $commercialNumber);
$stmt->execute();
$result = $stmt->get_result();
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <?php
                            if ($row['approval'] == 'no') {
                                echo '<span class="text-secondary text-xs font-weight-bold">Pending Approval</span>';
                            } else {
            ...
            echo "<tr><td colspan='5'>You haven't made any requests yet</td></tr>";
        }
        ?>
    </tbody>
</table>
