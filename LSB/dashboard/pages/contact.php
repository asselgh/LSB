              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
				  <form role="form" action="../../php/contact_proccess.php" method="POST">
                    <label>Email</label>
                    <div class="mb-3">
                      <input type="email" id="client_email" name="client_email" class="form-control" placeholder="Email" aria-label="Email" aria-describedby="email-addon" value="<?php echo $email; ?>" readonly>
                    </div>
                    <label>Message</label>
                    <div class="mb-3">
