        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" href="../pages/makerequest.html" hidden>Make a Request</a>
            </div>
          </div>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td>
						<a href="javascript:;" class="text-xs text-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" aria-label="hi people this is a test to see if this input works fine" data-bs-original-title="hi people this is a test to see if this input works fine" style="cursor: default;">
